...
namespace DLaB.EarlyBoundGeneratorV2.Settings
{
    ...
    public class ExtensionConfig
    {
        ...
        public void SetPopulatedValues(POCO.ExtensionConfig poco)
        {
            ...
            SerializedMetadataRelativeFilePath = GetValueOrDefault(poco.SerializedMetadataRelativeFilePath, GetValueOrDefault(SerializedMetadataRelativeFilePath, defaultSerializedMetadataRelativeFilePath));
