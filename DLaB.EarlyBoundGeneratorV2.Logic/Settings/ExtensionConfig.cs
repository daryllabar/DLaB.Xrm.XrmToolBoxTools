    ...
    public class ExtensionConfig
    {
        ...
        public static ExtensionConfig GetDefault()
        {
            return new ExtensionConfig
            {
                ...
                SerializedMetadataRelativeFilePath = DefaultSerializedMetadataRelativeFilePath,
        ...
        public void SetPopulatedValues(POCO.ExtensionConfig poco)
        {
            ...
            var serializedMetadataRelativeFilePathFallback = string.IsNullOrWhiteSpace(SerializedMetadataRelativeFilePath)
                ? DefaultSerializedMetadataRelativeFilePath
                : SerializedMetadataRelativeFilePath;
            SerializedMetadataRelativeFilePath = GetValueOrDefault(poco.SerializedMetadataRelativeFilePath, serializedMetadataRelativeFilePathFallback);
