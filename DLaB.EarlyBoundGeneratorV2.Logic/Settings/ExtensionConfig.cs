...
namespace DLaB.EarlyBoundGeneratorV2.Settings
{
    ...
    public class ExtensionConfig
    {
        ...
        /// <summary>
        /// Columns that contain "(Deprecated)" will be marked as obsolete when generated.
        /// </summary>
        ...
        public static ExtensionConfig GetDefault()
        {
            return new ExtensionConfig
            {
                ...
                SerializedMetadataRelativeFilePath = Path.Combine("Logs", "EBGV2.Metadata.xml"),
                SerializeMetadata = false,
                SuppressAutogeneratedFileHeaderComment = false,
                TokenCapitalizationOverrides = "AccessTeam|ActiveState|AssignedTo|BusinessAs|CardUci|DefaultOnCase|EmailAnd|EmailSend|EmailSender|ExchangeRate|FeatureSet|FedEx|ForAn|Geronimo|IsMsTeams|IsPaiEnabled|IsSopIntegration|MsDynCe_|MsDynMkt_|MsDyUsd|O365Admin|OcSkillIdentMlModel|OnHold|OrderId|OwnerOnAssign|PauseStates|PredictiveAddress|PartiesOnEmail|ParticipatesIn|SentOn|SettingsAndSummary|SlaId|SlaKpi|SyncOptIn|Timeout|TradeShow|UserPuid|VoiceMail",
        ...
        {
            var defaultSerializedMetadataRelativeFilePath = Path.Combine("Logs", "EBGV2.Metadata.xml");
            ...
            var currentSerializedMetadataRelativeFilePath = GetValueOrDefault(SerializedMetadataRelativeFilePath, defaultSerializedMetadataRelativeFilePath);
            SerializedMetadataRelativeFilePath = GetValueOrDefault(poco.SerializedMetadataRelativeFilePath, currentSerializedMetadataRelativeFilePath);
        ...
        public void WriteDLaBModelBuilderProperties(Utf8JsonWriter writer, EarlyBoundGeneratorConfig settings)
        {
            ...
            writer.AddProperty(nameof(SerializedMetadataRelativeFilePath), SerializedMetadataRelativeFilePath);
