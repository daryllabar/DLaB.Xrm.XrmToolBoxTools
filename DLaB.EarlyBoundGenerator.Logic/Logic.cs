        ...
        private void UpdateCrmSvcUtilConfig(EarlyBoundGeneratorConfig earlyBoundGeneratorConfig)
        {
            lock (_updateAppConfigToken)
            {
                ...
                if (
                    ...
                    UpdateConfigAppSetting(file, "FilePrefixText", extensions.FilePrefixText, true) |
                    ...
                    UpdateConfigAppSetting(file, "GenerateSeparateFiles", extensions.GenerateSeparateFiles.ToString()) |
