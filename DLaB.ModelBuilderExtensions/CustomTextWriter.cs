...
namespace DLaB.ModelBuilderExtensions
{
    internal class CustomTextWriter : TextWriter
    {
        ...
        private static string[] _makeReferenceTypesNullableBlacklist;
        ...
        public CustomTextWriter(string outputFile, bool skipRuntimeVersionComment, bool skipEntireHeaderComment, bool makeReferenceTypesNullable, string[] makeReferenceTypesNullableBlacklist)
        {
            ...
            _makeReferenceTypesNullableBlacklist = makeReferenceTypesNullableBlacklist ?? new string[0];
        }
        ...
        private static string UpdateLineForNullablePropertyTypes(string s)
        {
            ...
            if (!trimmed.StartsWith("public")
                || InvalidStringsForPropertiesNeedingNullableTypes.Any(trimmed.Contains) || _makeReferenceTypesNullableBlacklist.Any(trimmed.Contains)) return s;
