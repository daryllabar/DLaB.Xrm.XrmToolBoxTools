...
namespace DLaB.ModelBuilderExtensions.Serialization
{
    ...
    public class SerializableEntityMetadata
    {
        ...
        private Label _description = new();
        private Label _displayCollectionName = new();
        private Label _displayName = new();
        ...
        private BooleanManagedProperty _isAuditEnabled = new();
        private bool? _isAvailableOffline;
        private bool? _isChildEntity;
        private bool? _isAIRUpdated;
        private bool? _autoCreateAccessTeams;
        private BooleanManagedProperty _isValidForQueue = new();
        private BooleanManagedProperty _isConnectionsEnabled = new();
        private string _iconLargeName = null!;
        private string _iconMediumName = null!;
        private string _iconSmallName = null!;
        private bool? _isCustomEntity;
        private bool? _isBusinessProcessEnabled;
        private BooleanManagedProperty _isCustomizable = new();
        private BooleanManagedProperty _isRenameable = new();
        private BooleanManagedProperty _isMappable = new();
        private BooleanManagedProperty _isDuplicateDetectionEnabled = new();
        private bool? _isImportable;
        private bool? _isIntersect;
        private BooleanManagedProperty _isMailMergeEnabled = new();
        ...
        private string _entityHelpUrl = null!;
        private bool? _entityHelpUrlEnabled;
        private BooleanManagedProperty _isVisibleInMobile = new();
        private BooleanManagedProperty _isVisibleInMobileClient = new();
        private BooleanManagedProperty _isReadOnlyInMobileClient = new();
        ...
        private string _primaryNameAttribute = null!;
        private string _primaryImageAttribute = null!;
        private string _primaryIdAttribute = null!;
        private SecurityPrivilegeMetadata[] _privileges = [];
        private string _recurrenceBaseEntityLogicalName = null!;
        private string _reportViewName = null!;
        ...
        private string _introducedVersion = null!;
        private bool? _isStateModelAware;
        private bool? _enforceStateTransitions;
        private BooleanManagedProperty _canCreateAttributes = new();
        private BooleanManagedProperty _canCreateForms = new();
        private BooleanManagedProperty _canCreateCharts = new();
        private BooleanManagedProperty _canCreateViews = new();
        private BooleanManagedProperty _canBeRelatedEntityInRelationship = new();
        private BooleanManagedProperty _canBePrimaryEntityInRelationship = new();
        private BooleanManagedProperty _canBeInManyToMany = new();
        private BooleanManagedProperty _canModifyAdditionalSettings = new();
        private BooleanManagedProperty _canChangeHierarchicalRelationship = new();
        private BooleanManagedProperty _canChangeTrackingBeEnabled = new();
        private BooleanManagedProperty _canEnableSyncToExternalSearchIndex = new();
        private bool? _syncToExternalSearchIndex;
        private bool? _changeTrackingEnabled;
        private bool? _isOptimisticConcurrencyEnabled;
        private string _entityColor = null!;
        private EntityKeyMetadata[] _keys = [];
        private string _logicalCollectionName = null!;
        private string _collectionSchemaName = null!;
        private BooleanManagedProperty _isOfflineInMobileClient = new();
