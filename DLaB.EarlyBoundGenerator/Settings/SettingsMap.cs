...
namespace DLaB.EarlyBoundGenerator.Settings
{
    public partial class SettingsMap: IGetPluginControl<EarlyBoundGeneratorPlugin>
    {
        ...
        [Category("1 - Global")]
        [DisplayName("Generate Generated Code Attribute")]
        [Description("Specifies that generated the Code Generated By Early Bound Generator (X.X.X.X) Should be included as a header comment.")]
