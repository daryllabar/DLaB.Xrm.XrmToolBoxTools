...
namespace DLaB.ModelBuilderExtensions.Tests
{
    ...
    public class OptionSetMetadataAttributeGeneratorTests
    {
        ...
        public void TestGenerationNullable()
        {
            ...
            var codeNamespace = new CodeNamespace("Test");
            codeCompileUnit.Namespaces.Add(codeNamespace);
            var sut = new OptionSetMetadataAttributeGenerator(makeReferenceTypesNullable: true);
            ...
            var code = stringBuilder.ToString();
            Assert.AreEqual(ExpectedNullable, code.Trim());
        }

        // Note: the private field declarations (_nameObjects, _names) are intentionally non-nullable here
        // because those are post-processed by CustomTextWriter when MakeReferenceTypesNullable is true.
...
namespace Test {
	...
	public class OptionSetExtension {
		...
		public static OptionSetMetadataAttribute GetMetadata<T>(this T value)
			...
			System.Reflection.MemberInfo[] members = enumType.GetMember(value.ToString() ?? string.Empty);
