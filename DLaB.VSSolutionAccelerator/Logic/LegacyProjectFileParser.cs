...
{
    public class LegacyProjectFileParser
    {
        ...
        public List<string> PrePropertyGroupLines { get; set; }
        ...
        public LegacyProjectFileParser(IEnumerable<string> project)
        {
            if (project == null)
            {
            ...
            PrePropertyGroupLines = new List<string>();
        ...
        private void ParsePrePropertyGroup(string line)
        {
            ...
            {
                PrePropertyGroupLines.Add(line);
            }
        }
...
".Split(new[] {Environment.NewLine}, StringSplitOptions.None);
        ...
        public IEnumerable<string> GetProject()
        {
            ...
            foreach (var line in PrePropertyGroupLines)
            {
                yield return line;
            }
